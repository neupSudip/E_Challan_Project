    ...
    <footer>
        <div class="footer-div">
            <div >
                <picture>
                    <a class="echallan-a-footer" href="../php/index.php"><img class="echallan-logo-footer" src="../photo/e-challan.png" width=60px></a> 
                </picture>
        ...
        <hr>
        <div class="copyright">
            <span>Copyright &copy; 2021 e-challan.com</span>
